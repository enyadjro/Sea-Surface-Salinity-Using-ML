...
This version uses a 4x3 folds, so results can be compared to the eventual 6x4 folds
'''
...
# Config
BASE_DIR = os.getcwd()
OUT_ROOT = os.path.join(BASE_DIR, "model_sss_region_outputs_4x3Folds")
...
#------------------------------------------------------------------------------------------
    ...
    #------------------------------------------------------------------------------------------
        ...
        if fold_results:
            ...
            # Select best model by outer test R² (and use RMSE/MAE as tiebreakers)
    ...
    # Retrain the best model on the full dataset for final interpretation (i.e. not evaluation)
